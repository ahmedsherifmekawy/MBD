###########################################################################
## Makefile generated for Simulink model 'CalcSys'. 
## 
## Makefile     : CalcSys.mk
## Generated on : Tue Feb 22 11:05:50 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CalcSys.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/ITI/MBD/MyGitWork/Lab2/Task 2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = CalcSys_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = CalcSys_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CalcSys.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/CalcSys_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=CalcSys -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/CalcSys_ert_rtw/CalcSys.c

MAIN_SRC = $(START_DIR)/CalcSys_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/CalcSys_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
